...
<html>
  ...
  <script type="text/javascript">
  	function onclick1(id){
			window.location.href="${pageContext.request.contextPath}/FoodServlet?method=infor&id=" + id +"&pageCode=${pb.pageCode}";  			
  		}
  	function _go(select){
  		...
  		location="${pageContext.request.contextPath}/FoodServlet?method=find&pageCode=" + value;
          ...
          <ul class="sidebar-menu">
            <li class="treeview">
              ...
              <ul class="treeview-menu">              
				 <li><a href="${pageContext.request.contextPath }/pages/tables/production.jsp"><i class="fa fa-circle-o"></i>生产企业</a></li>
				 <li><a href="${pageContext.request.contextPath }/pages/tables/criculate.jsp"><i class="fa fa-circle-o"></i>流通企业</a></li>
				  <li><a href="${pageContext.request.contextPath }/pages/tables/food.jsp"><i class="fa fa-circle-o"></i>餐饮企业</a></li>
            ...
            <li class="treeview">
			  ...
			  <li><a href="${pageContext.request.contextPath }/ProductionServlet?method=find"><i class="fa fa-circle-o"></i>生产企业</a></li>
                <li class="active"><a href="${pageContext.request.contextPath }/servlet/CriculateServlet?method=find"><i class="fa fa-circle-o"></i>流通企业</a></li>
			...
			<li class="treeview active">
              <a href="#">
                <i class="fa fa-table"></i> <span>监督抽检</span>
                  ...
                  <table  class="table table-condensed" >                   
					...
					<tr>
                     ...
                     <c:forEach items="${pb.datas }" var="lis">
                  	...
                  	<a href="${pageContext.request.contextPath }/FoodServlet?method=find">首页</a>
                  	<c:if test="${pb.pageCode > 1}">
                  		<a href="${pageContext.request.contextPath }/FoodServlet?method=find&pageCode=${pb.pageCode-1}">上一页</a>
                  	</c:if>
                  	...
                  	<c:forEach begin="${begin}" end="${end}" var="i">
                  		<c:choose>
                  			...
                  			<c:otherwise>
                  				<a href="${pageContext.request.contextPath }/FoodServlet?method=find&pageCode=${i}">[${i }]</a>
                  			</c:otherwise>
                  		</c:choose>
                  	</c:forEach>
                  	
                  	<c:if test="${pb.pageCode < pb.totalPage}">
                  		<a href="${pageContext.request.contextPath }/FoodServlet?method=find&pageCode=${pb.pageCode+1}">下一页</a>
                  	</c:if>
                  	<a href="${pageContext.request.contextPath }/FoodServlet?method=find&pageCode=${pb.totalPage }">尾页</a>
