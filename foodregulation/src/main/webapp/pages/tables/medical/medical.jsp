...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
   	<script type="text/javascript">
		...
		function addNew3()
		{
			...
			tr.insertCell().innerHTML='<input   type=text  name=name  class=border_index>';   
			tr.insertCell().innerHTML='<input   type=text  name=manufacturer  class=border_index>';   
			tr.insertCell().innerHTML='<input   type=text  name=guiGe  class=border_index>';   
			tr.insertCell().innerHTML='<input   type=text  name=priductCode  class=border_index>';
			tr.insertCell().innerHTML='<input   type=text  name=supplier  class=border_index>';
			tr.insertCell().innerHTML='<input   type=text  name=time  class=border_index>';
          ...
          <div class="row" style="text-align:center">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
               <form id="formValidate8" action="javascript:void(0)" method="post">
                  ...
                  <table id="" class="table table-condensed" >                   
                    <tbody>
					 ...
					 <tr>
					  ...
					  <tr>
                        <td>经营地址(具体到门牌号)</td>
                        <td><input id="scaddress" type="text" style="width:280px" name="scaddress" class="" onblur="searchAddress('melongitude','melatitude')"/>
                        </td>
                        <td>邮政编码</td>
                      ...
                      <tr>
                        <td>经度</td>
                        <td><input id="melongitude" type="text" style="width:280px" class="" name="longitude" /></td>
						<td>纬度</td>
                        <td><input id="melatitude" type="text" style="width:280px" class="" name="latitude" /></td>
                      </tr>
                      ...
                      <tr>
					   ...
					   <tr>
						...
						<tr>
						<td colspan="2" align="right"><input type="button" onclick="save8()" class="btn btn-primary" width="30px" value="保存"/></td>						
