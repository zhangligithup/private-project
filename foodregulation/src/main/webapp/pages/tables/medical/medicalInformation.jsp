          ...
          <div class="row" style="text-align:center">
            <div class="col-xs-12">
              <div class="box">
                ...
                <form action="javascript:void(0)" method="post" onsubmit="return sumbit_sure()" id="medicalForm">
                  ...
                  <table id="" class="table table-condensed" >                   
                    <tbody>
					 ...
					 <tr>
					  ...
					  <tr>
                        <td>经营地址(具体到门牌号)</td>
                        <td><input id="scaddress" type="text" style="width:280px" name="scaddress" class="" value="${medical.scaddress }" onblur="searchAddress('melongitude','melatitude')"/>
                        </td>
                        <td>邮政编码</td>
                      ...
                      <tr>
                        <td>经度</td>
                        <td><input id="melongitude" type="text" style="width:280px" class="" name="longitude" value="${medical.longitude }"/></td>
						<td>纬度</td>
                        <td><input id="melatitude" type="text" style="width:280px" class="" name="latitude" value="${medical.latitude }"/></td>
                      </tr>
