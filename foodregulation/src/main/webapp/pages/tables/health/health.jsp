          ...
          <div class="row" style="text-align:center">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
               <form id="formValidate6" action="javascript:void(0)" method="post">
                  ...
                  <table id="" class="table table-condensed" >                   
                    <tbody>
					 ...
					 <tr>
					  ...
					  <tr>
                        <td>经营地址(具体到门牌号)</td>
                        <td><input id="scaddress" type="text" style="width:280px" name="scaddress" class="" onblur="searchAddress('helongitude','helatitude')"/>
                        </td>
                        <td>邮政编码</td>
                     ...
                     <tr>
                      ...
                      <tr>
                        <td>经度</td>
                        <td><input id="helongitude" type="text" style="width:280px" class="" name="longitude" /></td>
						<td>纬度</td>
                        <td><input id="helatitude" type="text" style="width:280px" class="" name="latitude" /></td>
                      </tr>
                      ...
                      <tr>
						...
						<tr>
						<td colspan="2" align="right"><input type="button" onclick="save6()" class="btn btn-primary" width="30px" value="保存"/></td>	
