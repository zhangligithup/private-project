          ...
          <div class="row" style="text-align:center">
            <div class="col-xs-12">
              <div class="box">
                ...
                <form action="javascript:void(0)" method="post" onsubmit="return sumbit_sure()" id="healthForm">
                  ...
                  <table id="" class="table table-condensed" >                   
                    <tbody>
					 ...
					 <tr>
					  ...
					  <tr>
                        <td>经营地址(具体到门牌号)</td>
                        <td><input id="scaddress" type="text" style="width:280px" name="scaddress" class="" value="${health.scaddress }" onblur="searchAddress('helongitude','helatitude')"/>
                        </td>
                        <td>邮政编码</td>
                      ...
                      <tr>
                        <td>经度</td>
                        <td><input id="helongitude" type="text" style="width:280px" class="" name="longitude" value="${health.longitude }"/></td>
						<td>纬度</td>
                        <td><input id="helatitude" type="text" style="width:280px" class="" name="latitude" value="${health.latitude }"/></td>
                      </tr>
