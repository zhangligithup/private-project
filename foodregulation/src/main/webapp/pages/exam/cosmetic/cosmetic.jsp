                     ...
                     <tr>
						<td align="center" colspan="2">
							...
							<select id="table" style="width: 280px" name="table" onchange="changeFunc();">
								...
								<option value="div1">化妆品抽样检验告知书</option>
								<option value="div2">化妆品抽样检验抽检单</option>
								<option value="div3">化妆品抽样检验工作质量及工作纪律反馈单</option>
								<option value="div4">化妆品抽样检验样品购置费用告知书</option>
								<option value="div5">现场检查笔录</option>
								<option value="div6">化妆品抽样检验样品信息登记表</option>
								<option value="div7">化妆品抽样检验样品移交确认单</option>
								<option value="div8">化妆品监督抽检检验结果告知书</option>
							</select>
						</td>
					</tr>
                    </tbody>
                  ...
                  <div class="container" id="div1" style="display: none">
				  		<div class="row" >
				  			<div class="col-lg-10 col-md-10">
				  					<h3 class="yk_h2" align="center">化妆品抽样检验告知书</h3>
				  		...
				  		<div class="row">
				  			<div class="col-lg-10 col-md-10">
				  					...
				  					<br/>
				  					被抽化妆品:<input type="text" style="border-top: none; border-right: none; border-left: none; border-bottom:1px #0F0F0F solid;width: 240px;" name="" id="" />
				  					<br/>
				  					<br/>	
				  		...
				  		<div class="row">
				  			<div class="col-lg-10 col-md-10">
				  					...
				  					<h3 class="yk_h2" align="center">化妆品抽样检验被抽样单位须知</h3>
				  					<p>
				  					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
									1．对化妆品进行抽样检验是食品药品监管部门（市场监管部门）依法履行监管职责的一项重要措施，任何单位和个人不得妨碍抽检工作的正常进行。被抽样单位无正当理由，对抽样工作不配合或者拒绝抽样检验的，按拒检处理。
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
									2．依据《化妆品卫生监督条例》的有关规定，抽样检验的样品通过购买的方式获取,不向被抽样单位收取检验费和其他任何费用。被抽样单位应及时将《化妆品抽样检验样品购置费用告知书》和相应的发票送至指定单位。
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
									3．化妆品抽样检验事先不通知被抽样单位。抽样人员不得少于2名，抽样前应向被抽样单位出示注明抽检监测内容的《化妆品抽样检验告知书》（原件）和抽样人员有效身份证件。抽样单位为承检机构的，抽样前还应向被抽样单位出示《化妆品抽样检验任务委托书》(复印件)。
									       样品应由抽样人员从化妆品生产者的成品库的待销产品、化妆品经营者销售的化妆品中抽取。化妆品标签、包装、说明书标有“试用”或者“样品”等字样的和全部用于出口的化妆品不在抽样范围。
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
									4．抽取的样品应由抽样人员自行送达或寄送至承检机构。确需被抽样单位协助寄送的，抽样人员应明确告知样品的寄、送要求。被抽样单位应在规定的时限内正确寄送，寄送样品的费用由抽样单位支付。
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
									5．被抽样单位应当协助抽样工作人员如实填写化妆品抽样检验抽样单。
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
									6．被抽样单位、生产者对执行此次抽检任务的单位、个人及有关抽检工作的任何意见，请填写《化妆品抽样检验工作质量及工作纪律反馈单》，填写完毕后寄送至指定单位。反馈意见者应留下电话、传真、Email等联系方式。
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
				  		...
				  		<div class="col-lg-12 col-md-12">
				  				<table align="center" border="1" style="width: 100%;height: 100%">
				  					...
				  					<tr>
				  						...
				  						<td colspan="8">
				  							&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" id="" name="" value="有因抽检">国家监督抽验          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" id="" name="" value="日常监督抽验">日常监督抽验&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" id="" name="" value="专项监督抽验">专项监督抽验&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" id="" name="" value="有因抽检"/>有因抽检                 
				  						</td>
				  					</tr>
				  					...
				  					<tr>
				  						...
				  						<td colspan="8"><input type="text" name="" id="" style="width: 100%;height: 100%;border: 0"></td>
				  					</tr>
				  					...
				  					<tr>
				  						...
				  						<td colspan="8">
				  							生产环节:	<input type="checkbox" name="" id="" value="成品库">成品库
				  							<input type="checkbox" name="" id="" value="其他">&nbsp;&nbsp; 其他
 												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 												<br/>
				  							经营环节:	
				  							<input type="checkbox" name="" id="" value="批发市场">批发市场	&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="小商店">小商店	&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="商场"> 商场	&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="超市"> 超市	&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="专卖店"> 专卖店	&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="药店">药店	&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="网购">网购	&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="美容美发场所">美容美发场所	&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="其他">其他
				  						</td>
				  					</tr>
				  					
				  					<tr>
				  						<td rowspan="6" align="center">样品信息</td>
				  						<td>样品类别</td>
				  						<td colspan="7">
				  							非特殊用途类:	
				  							<input type="checkbox" name="" id="" value="发用类">发用类&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="护肤类">护肤类&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="美容修饰类">美容修饰类&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="香水类"> 香水类
 												<br/>
				  							特殊用途类:	
				  							<input type="checkbox" name="" id="" value="育发">育发	&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="染发">染发	&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="烫发">烫发	&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="脱毛">脱毛	&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="美乳">美乳	&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="健美">健美	&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="除臭">除臭	&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="祛斑">祛斑	&nbsp;&nbsp;&nbsp;&nbsp;
				  							<input type="checkbox" name="" id="" value="其他">防晒
				  						</td>
				  					</tr>
				  					...
				  					<tr>
				  						<td colspan="2" align="center">生产日期</td>
				  						<td colspan="2"><input type="text" id="time21" readonly="readonly" name="" style="width:100%;height: 100%" placeholder="请选择"></td>
				  						<td colspan="2" align="center">限期使用日期/保质期</td>
				  						<td colspan="2"> <input type="text" name="" id="" style="width: 100%;height: 100%;border: 0"></td>
				  					</tr>
				  					
				  					<tr>
				  						<td colspan="2" align="center">生产许可证明文件号</td>
				  						<td colspan="2"><input type="text" name="" id="" style="width: 100%;height: 100%;border: 0"></td>
				  						<td colspan="2" align="center">批准文号/备案号</td>
				  						<td colspan="2"> <input type="text" name="" id="" style="width: 100%;height: 100%;border: 0"></td>
				  					</tr>
