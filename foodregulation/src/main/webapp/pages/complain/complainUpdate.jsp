                 ...
                 <input type="hidden" name="id" value="${complain.id }">
                  <table align="center" border="1" >                   
                    <tbody>
					 <tr>
                        <td align="center" colspan="2">投诉接报时间</td>
                         <td>
                         	<input type="text" id="time" readonly="readonly" name="complainTime" value="${complain.time }" style="width:280px" placeholder="请选择">
                         </td>
                         <td >受理编号</td>
                         <td><input type="text" name="number" value="${complain.number }"/></td>
                     </tr>
                     ...
                     <tr>
						...
						<td width="15%">姓名</td>
						<td width="25%"><input type="text" name="informerName" value="${complain.informerName }"/></td>
						<td width="15%">性别</td>
						<td width="25%"><input type="text" name="sex" value="${complain.sex }"/></td>
					</tr>
					
					<tr>
						<td>地址</td>
						<td><input type="text" name="address" value="${complain.address }"/></td>
						<td>联系电话</td>
						<td><input type="text" name="tel" value="${complain.tel }"/></td>
					</tr>
					
					<tr>
						<td rowspan="2" align="center">被投诉<br/>举　报<br/>单　位</td>
						<td>单位名称</td>
						<td><input type="text" name="name" value="${complain.name }"/></td>
						<td>联系电话</td>
						<td><input type="text" name="phone" value="${complain.phone }"/></td>
					</tr>
					
					<tr>
						<td  colspan="1">地址</td>
						<td colspan="3"><input type="text" name="scaddress" value="${complain.scaddress }"/></td>
					</tr>
					
					<tr>
						<td align="center">投　诉<br/>举　报<br/>内　容</td>
						<td colspan="4"><textarea name="content" style="width:100%;height:100%;border: 0px">${complain.content }</textarea></td>
					</tr>
					
					<tr>
						<td  align="center">拟　办<br/>意　见</td>
						<td  colspan="4"><textarea name="idea" style="width:100%;height:100%;border: 0px">${complain.idea }</textarea></td>
					</tr>
					
					<tr>
						<td  align="center">主要领导<br/>批办意见</td>
						<td  colspan="4" align="center">
							请${complain.department }调查处理，按时反馈。
						</td>
					</tr>
                    ...
                    <tr>
						...
						<input type="submit" class="btn btn-primary" width="30px" value="保存"/>	
                  </form>
