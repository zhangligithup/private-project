...
function onclick1(id){
  	...
  	function _onclick(){
  		...
  		location="${pageContext.request.contextPath}/servlet/CriculateServlet1?method=queryByName&queryQyName=" + value;
  	}
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
			  ...
			  <li><a href="${pageContext.request.contextPath }/ProductionServlet?method=find"><i class="fa fa-circle-o"></i>生产企业</a></li>
                <li class="active"><a href="#"><i class="fa fa-circle-o"></i>流通企业</a></li>
          ...
          <div class="row" style="text-align:center">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                <form id="formPage" action="${pageContext.request.contextPath}/servlet/CriculateServlet1" method="post">
                	<input type="hidden" name="method" value="find">
                	<input type="hidden" id="page" name="page">
                </form>
                <form id="form" action="${pageContext.request.contextPath}/servlet/CriculateServlet1" method="post">
                	<input type="hidden" name="method" value="infor">
                	<input id="id" type="hidden" name="id">
                	<input id="item" type="hidden" name="item" value="${item }">
                 
                  <input class="pull-left" type="text" id="queryQyName" name="queryQyName"/>&nbsp&nbsp&nbsp
                  <input class="pull-left" type="button"   value="搜索" onclick="_onclick()"></input>
                  <select class="pull-right" id="selectId" onchange="myonchange(this)">
                  		<option>请选择分局...</option>
					...
					<tr>
					 ...
					 <tr>
					 	<th width="25%" align="left">企业名称</th>						 
						<th width="20%" align="left">企业代码</th>
                        <th width="25%" align="left">经营场所</th>
                        <th width="18%" align="left">联系电话</th>
                        <th align="left">所属分局</th>
					 </tr>
