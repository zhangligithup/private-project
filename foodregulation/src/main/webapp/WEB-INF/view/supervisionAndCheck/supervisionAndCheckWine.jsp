...
<input type="hidden" value="" name="yibanQuestion">
    ...
    <div class="btn_box marb10" >
       <div style="text-align: center">
            <a href="javascript:void(0)" class="form_btn  width140" onclick="saveWine()">保 存</a>
        </div>
...
$(function(){
    $('#calenderOne006').datetimepicker({
        container:'#calenderOneBox006',
        weekStart: 1,
        todayBtn:  1,
        autoclose: 1,
        todayHighlight: 1,
