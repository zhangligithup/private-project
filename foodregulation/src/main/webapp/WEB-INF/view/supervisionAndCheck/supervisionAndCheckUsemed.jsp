...
<div class="breadcrumb_box">
    <div class="breadcrumb_box_l">
        <ol class="breadcrumb">
            <li><a href="#">首页</a></li>
            <li><a href="#">监督检查</a></li>
            <li class="active">添加医疗器械使用监督检查</li>
        </ol>
    </div>
...
<input type="hidden" value="" name="yibanQuestion">
    ...
    <div class="btn_box marb10" >
        <div style="text-align: center">
            <a href="javascript:void(0)" class="form_btn  width140" onclick="saveUsemed()">保 存</a>
        </div>
...
$(function(){
    $('#calenderOne010').datetimepicker({
        container:'#calenderOneBox010',
        weekStart: 1,
        todayBtn:  1,
        autoclose: 1,
        todayHighlight: 1,
