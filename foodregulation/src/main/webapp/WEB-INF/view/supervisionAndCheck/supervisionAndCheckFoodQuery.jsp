...
<div class="content_box">
    ...
    <table class="table  table3">
        ...
        <tr>
            ...
            <td>
            	<div id="calenderOneBox027" style="position:relative">
                            <input id="calenderOne027" name="checkDate" class="input2 bg_calender" size="16" type="text" value="${supervisionAndCheck.checkDate}">
                </div>
           </td>
        </tr>
        </tbody>
...
<input type="hidden" value="" name="yibanQuestion">
    ...
    <div class="btn_box marb10" >
        <div style="text-align: center">
            <a href="javascript:void(0)" class="form_btn  width140" onclick="updateFood()">保 存</a>
        </div>
...
$(function(){
    $('#calenderOne027').datetimepicker({
        container:'#calenderOneBox027',
        weekStart: 1,
        todayBtn:  1,
        autoclose: 1,
        todayHighlight: 1,
    ...
    $('#calenderOne028').datetimepicker({
        container:'#calenderOneBox028',
        weekStart: 1,
        todayBtn:  1,
        autoclose: 1,
        todayHighlight: 1,
