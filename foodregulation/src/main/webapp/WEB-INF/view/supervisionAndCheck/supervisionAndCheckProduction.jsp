...
<input type="hidden" value="" name="yibanQuestion">
    ...
    <div class="btn_box marb10" >
        <div style="text-align: center">
            <a href="javascript:void(0)" class="form_btn  width140" onclick="saveProduction()">保 存</a>
        </div>
...
$(function(){
    $('#calenderOne014').datetimepicker({
        container:'#calenderOneBox014',
        weekStart: 1,
        todayBtn:  1,
        autoclose: 1,
        todayHighlight: 1,
