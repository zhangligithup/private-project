...
<div class="content_box">
    ...
    <table class="table  table3">
        ...
        <tr>
            ...
            <td>
            	<div id="calenderOneBox035" style="position:relative">
                            <input id="calenderOne035" name="checkDate" class="input2 bg_calender" size="16" type="text" value="${supervisionAndCheck.checkDate}">
                </div>
           </td>
        </tr>
        </tbody>
    ...
    <table class="table  table3">
        ...
        <tr>
            ...
            <td><input type="text" class="input2" name="checkedEnterpriseOption" value="${supervisionAndCheck.checkedEnterpriseOption}"></td>
        </tr>
        <tr>
...
<input type="hidden" value="" name="yibanQuestion">
    ...
    <div class="btn_box marb10" >
        <div style="text-align: center">
            <a href="javascript:void(0)" class="form_btn  width140" onclick="updateCriculate()">保 存</a>
        </div>
...
$(function(){
    $('#calenderOne035').datetimepicker({
        container:'#calenderOneBox035',
        weekStart: 1,
        todayBtn:  1,
        autoclose: 1,
        todayHighlight: 1,
    ...
    $('#calenderOne036').datetimepicker({
        container:'#calenderOneBox036',
        weekStart: 1,
        todayBtn:  1,
        autoclose: 1,
        todayHighlight: 1,
