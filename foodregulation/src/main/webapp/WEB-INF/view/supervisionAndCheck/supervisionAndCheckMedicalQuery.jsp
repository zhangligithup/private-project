    ...
    <div class="titledivone marb3">
     ...
     <table class="table  table3">
        ...
        <tr>
            ...
            <td>
            	<div id="calenderOneBox015" style="position:relative">
                            <input id="calenderOne015" name="checkDate" class="input2 bg_calender" size="16" type="text" value="${supervisionAndCheck.checkDate}">
                </div>
           </td>
        </tr>
        </tbody>
...
<input type="hidden" value="" name="yibanQuestion">
    ...
    <div class="btn_box marb10" >
        <div style="text-align: center">
            <a href="javascript:void(0)" class="form_btn  width140" onclick="updateMedical()">保 存</a>
        </div>
    </div>
...
$(function(){
    $('#calenderOne015').datetimepicker({
        container:'#calenderOneBox015',
        weekStart: 1,
        todayBtn:  1,
        autoclose: 1,
        todayHighlight: 1,
    ...
    $('#calenderOne016').datetimepicker({
        container:'#calenderOneBox016',
        weekStart: 1,
        todayBtn:  1,
        autoclose: 1,
        todayHighlight: 1,
