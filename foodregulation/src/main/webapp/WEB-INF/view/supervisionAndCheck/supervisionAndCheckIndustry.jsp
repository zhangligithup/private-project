...
<input type="hidden" value="" name="yibanQuestion">
    ...
    <div class="btn_box marb10" >
        <div style="text-align: center">
            <a href="javascript:void(0)" class="form_btn  width140" onclick="saveIndustry()">保 存</a>
        </div>
...
$(function(){
    $('#calenderOne022').datetimepicker({
        container:'#calenderOneBox022',
        weekStart: 1,
        todayBtn:  1,
        autoclose: 1,
        todayHighlight: 1,
