    ...
    <table class="table table-bordered table2" id="drugProject">
       ...
       <tr>
        ...
        <tr>
            ...
            <textarea  cols="30" rows="10"  class="login_input login_textarea " id="otherQuestion"></textarea></td>
        </tr>
        <tr>
...
<input type="hidden" value="" name="yibanQuestion">
    ...
    <div class="btn_box marb10" >
       <div style="text-align: center">
            <a href="javascript:void(0)" class="form_btn  width140" onclick="saveDrug()">保 存</a>
        </div>
...
$(function(){
    $('#calenderOne034').datetimepicker({
        container:'#calenderOneBox034',
        weekStart: 1,
        todayBtn:  1,
        autoclose: 1,
        todayHighlight: 1,
