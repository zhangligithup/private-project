...
<div class="breadcrumb_box">
    <div class="breadcrumb_box_l">
        <ol class="breadcrumb">
            <li><a href="#">首页</a></li>
            <li><a href="#">监督检查</a></li>
            <li class="active">添加化妆品销售监督检查</li>
        </ol>
    </div>
...
<div class="content_box">
    ...
    <table class="table table-bordered table2" id="cosmeticProject">
      ...
      <tr>
        ...
        <tr>
            <td class="width220 text-left " colspan="5" ><textarea cols="30" rows="10"  class="login_input login_textarea " id="otherQuestion"></textarea></td>
        </tr>
        <tr>
...
<input type="hidden" value="" name="yibanQuestion">
    ...
    <div class="btn_box marb10" >
        <div style="text-align: center">
            <a href="javascript:void(0)" class="form_btn  width140" onclick="saveCosmetic()">保 存</a>
        </div>
...
$(function(){
    $('#calenderOne042').datetimepicker({
        container:'#calenderOneBox042',
        weekStart: 1,
        todayBtn:  1,
        autoclose: 1,
        todayHighlight: 1,
