...
<form id="addscIndustry">
<input type = "hidden" value="enterprise_5" name="enterpriseTypeCode">
<div class="breadcrumb_box">
    <div class="breadcrumb_box_l">
        <ol class="breadcrumb">
            <li><a href="#">首页</a></li>
            <li><a href="#">监督检查</a></li>
            <li class="active">食品五小监督检查</li>
        </ol>
    </div>
...
<div class="content_box">
    <div class="titledivone marb3">
     ...
     <table class="table  table3">
        ...
        <tr>
            ...
            <td>
            	<div id="calenderOneBox019" style="position:relative">
                            <input id="calenderOne019" name="checkDate" class="input2 bg_calender" size="16" type="text" value="${supervisionAndCheck.checkDate}">
                </div>
           </td>
        </tr>
        </tbody>
    ...
    <table class="table table-bordered table2" id="industryProject">
        <thead>
        <tr>
          ...
          <td ><SPAN lang="EN-US">1.</SPAN>许可管理<SPAN lang="EN-US"></SPAN></td>
            ...
            <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio1">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio1">否
                    </label>
                </div>
        ...
        <tr>
            ...
            <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio2">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio2">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio3">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio3">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio4">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio4">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio5">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio5">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio6">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio6">否
                    </label>
                </div></td>
            <td>&nbsp;</td>
        </tr>
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio7">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio7">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio8">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio8">否
                    </label>
                </div>
        ...
        <tr>
          <td>4.3</td>
          <td>具有从业人员食品安全培训记录。<SPAN lang="EN-US"></SPAN><SPAN lang="EN-US"></SPAN></td>
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio9">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio9">否
                    </label>
                </div>
        ...
        <tr>
          <td>4.4</td>
          <td>从业人员穿戴清洁的工作衣帽，双手清洁，保持个人卫生。<SPAN lang="EN-US"></SPAN><SPAN lang="EN-US"></SPAN></td>
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio10">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio10">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio11">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio11">否
                    </label>
                </div>
        ...
        <tr>
          <td>5.2</td>
          <td>烹饪场所配置排风设备，定期清洁。<SPAN lang="EN-US"></SPAN><SPAN lang="EN-US"></SPAN></td>
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio12">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio12">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio13">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio13">否
                    </label>
                </div>
        ...
        <tr>
          <td>5.4</td>
          <td>卫生间保持清洁、卫生，定期清理。<SPAN lang="EN-US"></SPAN><SPAN lang="EN-US"></SPAN></td>
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio14">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio14">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>*6.1</td>
          <td>查验供货者的许可证和食品出厂检验合格证或其他合格证明，企业如实记录有关信息并保存相关凭证。<SPAN lang="EN-US"></SPAN><SPAN lang="EN-US"></SPAN></td>
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio15">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio15">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio16">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio16">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio17">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio17">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>*7.1</td>
          <td>食品原料、半成品与成品在盛放、贮存时相互分开。<SPAN lang="EN-US"></SPAN><SPAN lang="EN-US"></SPAN></td>
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio18">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio18">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio19">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio19">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio20">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio20">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio21">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio21">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio22">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio22">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio23">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio23">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio24">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio24">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio25">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio25">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio26">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio26">否
                    </label>
                </div>
         ...
         <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio27">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio27">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio28">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio28">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio29">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio29">否
                    </label>
                </div>
        ...
        <tr>
          ...
          <td>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="1" name="industryradio30">是
                    </label>
                </div>
                <div class="myradio radio-inline">
                    <label class=" ">
                        <input type="radio"  value="2" name="industryradio30">否
                    </label>
                </div>
        ...
        <tr>
            <td class="width220 text-left p20" colspan="5" ><p>说明：<span lang="EN-US">1.</span>表中重点项<span lang="EN-US">(*) 6</span>项<span lang="EN-US">,</span>一般项<span lang="EN-US">24</span>项<span lang="EN-US">,</span>共<span lang="EN-US">30</span>项。每次检查的重点项应不少于<span lang="EN-US">3</span>项，一般项应不少于<span lang="EN-US">7</span>项。<span lang="EN-US"> </span></p>
              <p align="left"><span lang="EN-US">2.</span>检查结果判定方法：①符合：未发现检查的重点项和一般项存在问题；②基本符合：发现检查的重点项存在<span lang="EN-US">1</span>项及以下不<span lang="EN-US"> </span></p>
              <p align="left"><span lang="EN-US">            </span>合格且<span lang="EN-US">70%</span>≤一般项合格率＜<span lang="EN-US">100%</span>；③不符合：发现检查的重点项存在<span lang="EN-US">2</span>项及以上不合格，或一般项合格率＜<span lang="EN-US">70%</span>。<span lang="EN-US"> </span></p>
              <p align="left"><span lang="EN-US">3</span>．当次检查发现的不合格项目，应列入下次检查必查项目。<span lang="EN-US"> </span></p>
              <p align="left"><span lang="EN-US">4</span>．存在合理缺项时，一般项合格率的计算方法为：合格项目数<span lang="EN-US">/</span>（检查的项目数－合理缺项的项目数）×<span lang="EN-US">100%</span>。<span lang="EN-US"> </span></p>
            <p align="left"><span lang="EN-US"> </span></p></td>
        </tr>
        </tbody>
    </table>
    <div class="add_check_box marb10">
        ...
        <ul class="add_check ">
            ...
            <li class="width350">
                <label class="radio radio-inline">
                    <input type="radio"  value="3" name="resultHandle">"五小"食品经营者立即停止"五小"食品经营活动 
                </label>
            </li>
        </ul>
    </div>
...
<input type="hidden" value="" name="yibanQuestion">
    ...
    <div class="btn_box marb10" >
        <div style="text-align: center">
            <a href="javascript:void(0)" class="form_btn  width140" onclick="updateIndustry()">保 存</a>
        </div>
...
$(function (){
	...
	if($("#checkProject").html()!=""){
		$("#industryProject").find("input[type='radio']").each(function (){
			var tdv = "";
...
$(function (){
	$("#industryProject").find("input[type='radio']").change(function(){
		statistics($(this));
	  });	
}
);
...
$(function(){
    $('#calenderOne019').datetimepicker({
        container:'#calenderOneBox019',
        weekStart: 1,
        todayBtn:  1,
        autoclose: 1,
        todayHighlight: 1,
    ...
    $('#calenderOne020').datetimepicker({
        container:'#calenderOneBox020',
        weekStart: 1,
        todayBtn:  1,
        autoclose: 1,
        todayHighlight: 1,
