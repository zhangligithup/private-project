...
<div class="content_box details_tabs">
            ...
            <form id="purchaseLedgerEditForm">
                ...
                <table class="table  table3">
                    ...
                    <tr>
                        ...
                        <td width="35%" class="text-left"><input type="text" onblur="checkIsHave(this)" class="input2" id="company" name="company" value=""></td>
                        <td  class="table3_th">物品名称</td>
                        <td class="text-left"><input type="text" id="commodity" class="input2" name="commodity" value=""></td>
                    </tr>
                    <tr>
                        <td class="table3_th">规格</td>
                        <td  class="text-left"><input type="text" id = "spec" class="input2" name="spec" value=""></td>
                        <td  class="table3_th">数量</td>
                        <td class="text-left"><input type="text" id="num" class="input2" name="num" value=""></td>
                    </tr>
                    <tr>
                        <td class="table3_th">生产日期</td>
                        <td  class="text-left">
                            <div id="addbatchNumberBox1" style="position:relative">
                                <input type="text" id="addbatchNumber" class="input2" name="batchNumber" value="">
                            </div>
                        </td>
                        <td  class="table3_th">保质期</td>
                        <td class="text-left">
                          <div id="addSafeDateStrBox1" style="position:relative">
                            <input type="text" id="addsafeDateStr" class="input2" name="safeDateStr" value="">
                           </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="table3_th">产地</td>
                        <td  class="text-left"><input type="text" id = "productionPlace" class="input2" name="productionPlace" value=""></td>
                    ...
                    <tr>
                        ...
                        <td class="text-left">
                           <div id="addPurchasecalenderOneBox1" style="position:relative">
                               <input type="text" id="addpurchaseTimeStr" class="input2" name="purchaseTimeStr" value="">
                           </div>
                        </td>
                        <td  class="table3_th">供货单位</td>
                        <td class="text-left"><input type="text" id="supplyUnit" class="input2" name="supplyUnit" value=""></td>
                    </tr>
                    <tr>
                        <td class="table3_th">供货单位联系人</td>
                        <td  class="text-left"><input type="text" class="input2" name="supplyPerson" value=""></td>
                        <td  class="table3_th">供货人联系电话</td>
                        <td class="text-left"><input type="text" class="input2" name="supplyTel" value=""></td>
                    </tr>
                    <tr>
                        <td class="table3_th">上传进货票据<font style="color: red">*</font></td>
                        <td id="addPurchaseLedgerTd">
                             <div id="addZyuploadPurchaseLedger" class="zyupload row-fluid">
                             </div>
                        </td>
                    </tr>
                    </tbody>
    ...
    <div class="btn_box marb10" >
        <div style="text-align: center">
            <a href="javascript:void(0)" class="form_btn  width140" onclick="savePurchaseLedger()">保 存</a>
        </div>
    </div>
</div>
...
function initFile(){
    ...
    // 初始化插件
 $("#addZyuploadPurchaseLedger").zyUpload({
     width            :   "650px",                 // 宽度
     height           :   "400px",                 // 宽度
...
$(function(){
    $('#addpurchaseTimeStr').datetimepicker({
        container:'#addPurchasecalenderOneBox1',
        weekStart: 1,
        todayBtn:  1,
        autoclose: 1,
        todayHighlight: 1,
    ...
    $('#addsafeDateStr').datetimepicker({
        container:'#addSafeDateStrBox1',
        weekStart: 1,
        todayBtn:  1,
        autoclose: 1,
        todayHighlight: 1,
    ...
    $('#addbatchNumber').datetimepicker({
        container:'#addbatchNumberBox1',
        weekStart: 1,
        todayBtn:  1,
        autoclose: 1,
        todayHighlight: 1,
...
function savePurchaseLedger(){
	if(!$("#company").val()){
        alertEase("企业名称不能为空",2);
        return;
    }
    if(!$("#addpurchaseTimeStr").val()){
    ...
    $.ajax({
        url:"${pageContext.request.contextPath}/origin/savePurchaseLedger.do",
        type:"post",
        async:false,
