	...
	function _myonclick(page){
		var pc;
  		...
  		var ur;
  		var tp;
        	 var url = "${pageContext.request.contextPath }/SuperviseFindServlet";
        	 ...
        	 $.ajax({
     	        ...
     	        success: function(jsonData) {
     				tp = jsonData.pb.totalPage;//总页数
      				...
      				ur = jsonData.pb.url;
     				var htmlStr = "<tr><td colspan='2'><b>监管动态</b></td><td colspan='2' align='right'><a href='${pageContext.request.contextPath }/pages/index.jsp'>返回</a></td></tr>";
     				var htmlPc = "";
