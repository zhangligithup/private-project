...
public class Drug_jdjc  {
    ...
    private String medisvalue1str;
    
    private String medisvalue0str;
    ...
    public String getMedisvalue1str() {
		return medisvalue1str;
	}

	public void setMedisvalue1str(String medisvalue1str) {
		this.medisvalue1str = medisvalue1str;
	}

	public String getMedisvalue0str() {
		return medisvalue0str;
	}

	public void setMedisvalue0str(String medisvalue0str) {
		this.medisvalue0str = medisvalue0str;
	}

	public String getMedmarkstr() {
		return medmarkstr;
	}

	public void setMedmarkstr(String medmarkstr) {
		this.medmarkstr = medmarkstr;
	}
