...
public class Drug {
    ...
    private String fdeduc;

    private String fdprofess;

    private String qydelegate;

    private String qyeduc;

    private String qyprofess;

    private String zldelegate;

    private String zleduc;

    private String zlprofess;

    private String zydelegate;

    private String zyeduc;

    private String zyprofess;
    ...
    private String gsppermit;

    private String gspfazhengjiguan;

    private String gspfazhengriqi;

    private String gspyouxiaodate;
    ...
    private String zhongarea;

    private String changarea;

    private String yinarea;
